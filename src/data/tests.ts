    ...
    options: [
      {
        ...
        characters: ['Cinamon', 'Coby', 'Somsom'],
      },
      {
        text: '여행계획이 틀어지더라도 모두 기다렸다가 같이 간다.',
        characters: ['Totti', 'Hiff'],
      },
      {
        text: '이런 결정은 대세에 따라야지~ 잠잠코 있는다.',
        characters: ['Munboo', 'Vanilla'],
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        characters: ['Totti', 'Munboo', 'Hiff'],
      },
      {
        text: '여행지에서 놀아야 하니까 지금은 잠깐 자두겠어..',
        characters: ['Cinamon', 'Coby'],
      },
      {
    ...
    options: [
      {
        ...
        characters: ['Vanilla', 'Somsom', 'Hiff'],
      },
      {
        text: '우선, 지도 앱부터 켜서 숙소에 짐을 가져다 놔야지!',
        characters: ['Munboo', 'Cinamon'],
      },
      {
    ...
    options: [
      {
        ...
        characters: ['Totti', 'Cinamon', 'Somsom'],
      },
      {
    ...
    options: [
      {
        ...
        characters: ['Munboo', 'Cinamon', 'Hiff', 'Somsom'],
      },
      {
        text: '후다닥~ 도망가 버린다. 언어 울렁증~',
        characters: ['Vanilla', 'Coby'],
      },
      {
    ...
    options: [
      {
        ...
        characters: ['Totti', 'Vanilla', 'Hiff'],
      },
      {
        text: '내 몸에는 화장실 레이더가 있지! 바로 찾아간다.',
        characters: ['Munboo', 'Cinamon', 'Coby', 'Somsom'],
      },
    ],
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        characters: ['Munboo', 'Cinamon', 'Hiff'],
      },
    ],
  },
  {
